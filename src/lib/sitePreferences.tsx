...
const zh: Record<string, string> = {
  ...
  'Begin With Your Invitation': '请先输入邀请信息',
  ...
  'Add to Apple Calendar / download .ics': '添加到 Apple 日历 / 下载 .ics',
  'Russell & Siaw Min Wedding Dinner': 'Russell 与 Siaw Min 婚宴',
  'Russell & Siaw Min Nuptial Mass': 'Russell 与 Siaw Min 婚配弥撒',
